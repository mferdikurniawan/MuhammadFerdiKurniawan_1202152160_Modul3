package com.example.ferdi.ferdi_1202152160_modul3;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Berhasil Login", Toast.LENGTH_LONG);
    ...
    //method ini berfungsi untuk mengecek apakah username password benar atau salah
